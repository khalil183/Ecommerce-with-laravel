                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="m-b-40">{{$item->slider_thumbnail}}</p>
                                <p><a class="btn hvr-hover" href="{{route('product.details',$item->product_slug)}}">Shop New</a></p>
                            </div>
                        </div>
                    </div>
                </li>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="offer-box-products">
						<img class="img-fluid" src="{{asset('public/frontend/images/add-img-01.jpg')}}" alt="" />
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="offer-box-products">
						<img class="img-fluid" src="{{asset('public/frontend/images/add-img-02.jpg')}}" alt="" />
					</div>
				</div>
			</div>
		</div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        <h1>BuyOne And GetOne</h1>
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nisi inventore distinctio quasi ab? Repellat?</p>
                    </div>
                </div>
            </div>
            <div class="row special-list">
                @foreach ($buyone_getone as $item)
                        ...
                        <div class="products-single fix">
                            <div class="box-img-hover">
                                ...
                                <div class="mask-icon">
                                    ...
                                    <a onclick="productDetails({{$item->product_id}})" class="cart" data-toggle="modal" data-target="#modelId" href="javascript:void(0)">Add to Cart</a>
